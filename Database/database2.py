...
>>>>>>> 49d7ff41a18911d4e7d1721cacdd2dd23e4600a0
    mc.execute(qry)
...
def New_Student(uid, name, branch, mobile, father_name, father_mobile, hostel='NA', room_no=0):
    mc.execute("INSERT INTO student_details(uid,name,branch,hostel_name,room_no,mobile,father_name,father_mobile) VALUES ('{}','{}','{}','{}','{}','{}','{}','{}')".format(
        uid, name, branch, hostel, room_no, mobile, father_name, father_mobile))
    cn.commit()
...
def pass_creation(pid, uid, name, place, permit, branch):
    ...
    mc.execute("INSERT INTO global_log(pid,uid,name,place_of_visit,permit_time,branch) VALUES ('{}','{}','{}','{}','{}','{}')".format(
        pid, uid, name, place, permit, branch))
    cn.commit()
...
pass_creation(1, "21BCS2324", "Shivam Kumar",
              "Kharar", "2022-11-11 11:11:11", "CSE")
checkout("21BCS2324", 1, '2022-11-11 09:11:11')
checkin("21BCS2324", 1, '2022-11-11 10:11:11')
